    ...
    **Returns:** A valid FFmpeg executable path string.
    ...
    if os_windows and os_bit:
        ...
        if os.path.isfile(file_path):
            ...
            raise RuntimeError("No Custom FFmpeg path provided. Auto-Installing FFmpeg static binaries from GitHub Mirror now. Please wait...")
    # return final path
    return final_path
...
def check_sp_output(*args, **kwargs):
    ...
    **Returns:** A string value.
    ...
    print(f"ffmpeg helper started: '{' '.join(args[0])}'")
